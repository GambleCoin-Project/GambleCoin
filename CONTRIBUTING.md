Contributing to GambleCoin Core
============================

The GambleCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the GambleCoin Core project, and is not to be
confused with overall GambleCoin Network Protocol consensus changes.

Whether a pull request is merged into GambleCoin Core rests with the project merge
...
Patches that change GambleCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the GambleCoin consensus, it must have been
...
The project leader is the release manager for each GambleCoin Core release.
