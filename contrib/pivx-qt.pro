...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/gamblecoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/gamblecoin-cli.cpp \
           src/gamblecoin-tx.cpp \
           src/gamblecoin.cpp \
           src/db.cpp \
           ...
           src/qt/gamblecoin.cpp \
           src/qt/gamlecoinstrings.cpp \
...
RESOURCES += src/qt/gamblecoin.qrc src/qt/gamblecoin_locale.qrc

TRANSLATIONS += src/qt/locale/gamblecoin_bg.ts \
                src/qt/locale/gamblecoin_de.ts \
                src/qt/locale/gamblecoin_en.ts \
                src/qt/locale/gamblecoin_es.ts \
                src/qt/locale/gamblecoin_fi.ts \
                src/qt/locale/gamblecoin_fr.ts \
                src/qt/locale/gamblecoin_it.ts \
                src/qt/locale/gamblecoin_ja.ts \
                src/qt/locale/gamblecoin_pl.ts \
                src/qt/locale/gamblecoin_pt.ts \
                src/qt/locale/gamblecoin_ru.ts \
                src/qt/locale/gamblecoin_sk.ts \
                src/qt/locale/gamblecoin_sv.ts \
                src/qt/locale/gamblecoin_vi.ts \
                src/qt/locale/gamblecoin_zh_CN.ts \
                src/qt/locale/gamblecoin_zh_TW.ts
