...
In order to support loading of multiple wallets in gamblecoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is gamblecoin.cpp.
...
Changes to gamblecoin.cpp
----------------------
gamblecoin.cpp is the entry point into gamblecoin-qt, and as such, will require some minor modifications to provide hooks for
