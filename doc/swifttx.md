...
This mechanism has been integrated into Bitcore-Node-GambleCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/GambleCoin-Project/insight-api-gamblecoin#web-socket-api](https://github.com/GambleCoin-Project/insight-api-gamblecoin#web-socket-api) 
* API: [https://github.com/GambleCoin-Project/insight-api-gamblecoin#swifttx-transactions](https://github.com/GambleCoin-Project/insight-api-gamblecoin#swifttx-transactions) 
...
By default, the GambleCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the GambleCoin Core daemon:
