...
/** 
    ...
    ****Note - for GambleCoin we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of gamblecoin coming in to a transaction
