/* src/config/gamblecoin-config.h.  Generated from gamblecoin-config.h.in by configure.  */
/* src/config/gamblecoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef GMCN_CONFIG_H

#define GMCN_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.gamblecoin.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "GambleCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "GambleCoin Core 3.0.99"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "gamblecoin"
