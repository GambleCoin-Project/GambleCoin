...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("GambleCoin Core gamblecoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  gamblecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded gamblecoin transaction") + "\n" +
                               "  gamblecoin-tx [options] -create [commands]   " + _("Create hex-encoded gamblecoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded gamblecoin transaction
