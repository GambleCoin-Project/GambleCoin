                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("GambleCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a GambleCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and gamblecoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zGMCN"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About GambleCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about GambleCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for GambleCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your GambleCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified GambleCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a GambleCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the GambleCoin Core help message to get a list with possible GambleCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("GambleCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to GambleCoin network", "", count));
}
...
{
    QString strTitle = tr("GambleCoin Core"); // default title
