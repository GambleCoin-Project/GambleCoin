...
static std::string ValueToString(CAmount nValue, bool AllowNegative = false)
{
    ...
    QString Str = BitcoinUnits::formatWithUnit(BitcoinUnits::GMCN, nValue);
...
void BlockExplorer::showEvent(QShowEvent*)
{
    if (m_NeverShown) {
        ...
        if (!GetBoolArg("-txindex", true)) {
            QString Warning = tr("Not all transactions will be shown. To view all transactions you need to set txindex=1 in the configuration file (gamblecoin.conf).");
            QMessageBox::warning(this, "GambleCoin Core Blockchain Explorer", Warning, QMessageBox::Ok);
        }
    }
}
...
{
    QString CSS = "body {font-size:12px; color:#f6f6f8; bgcolor:#053a7d;}\n a, span { font-family: monospace; }\n span.addr {color:#053a7d; font-weight: bold;}\n table tr td {padding: 3px; border: 1px solid black; background-color: #053a7d;}\n td.d0 {font-weight: bold; color:#f6f6f8;}\n h2, h3 { white-space:nowrap; color:#053a7d;}\n a { color:#ffc600; text-decoration:none; }\n a.nav {color:#053a7d;}\n";
