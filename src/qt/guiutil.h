...
/** Utility functions used by the GambleCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render GambleCoin addresses in monospace font
...
// Parse "gamblecoin:" URI into recipient object, return true on successful parsing
