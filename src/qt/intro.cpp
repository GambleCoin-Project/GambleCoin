...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("GambleCoin Core"),
     ...
     * override -datadir in the gamblecoin.conf file in the default data directory
     * (to be consistent with gamblecoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
